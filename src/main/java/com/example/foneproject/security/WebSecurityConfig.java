    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.authorizeHttpRequests(
                        authorize -> authorize
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/v1/customers", "/api/v1/accounts").hasAuthority("ADMIN")
                                .requestMatchers(HttpMethod.GET, "/api/v1/transactions/**").hasAuthority("CUSTOMER")
                                .requestMatchers(HttpMethod.PUT, "/api/v1/customers/**").hasAuthority("CUSTOMER")
